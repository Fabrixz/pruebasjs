...
if (btn.value == 'fotr') {
    url = 'json/john1Ques.json';
    document.body.style.backgroundImage = "url('./images/john_wick1.jpg')";
...
if (btn.value == 'ttt') {
    url = 'json/john3Ques.json';
    document.body.style.backgroundImage = "url('./images/john_wick3.jpg')";
    document.body.style.backgroundRepeat = 'no-repeat';
    document.body.style.backgroundSize = 'cover';
    backgroundBlendMode = 'lighten';
}
if (btn.value == 'rotk') {
    url = 'json/john2Ques.json';
    document.body.style.backgroundImage = "url('./images/johnwick2.jpg')";
    document.body.style.backgroundRepeat = 'no-repeat';
    document.body.style.backgroundSize = 'cover';
    backgroundBlendMode = 'lighten';
}
